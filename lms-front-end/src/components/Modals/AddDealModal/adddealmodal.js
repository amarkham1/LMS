...
class AddDealModal extends React.Component {
  ...
  async componentDidMount() {
    await fetch(
      "https://intense-temple-63357.herokuapp.com/adddealmodal/tenant",
      {
        method: "get",
    ...
    await fetch(
      "https://intense-temple-63357.herokuapp.com/adddealmodal/llbroker",
      {
        method: "get",
        headers: { "Content-Type": "application/json" }
      }
    ...
    await fetch(
      "https://intense-temple-63357.herokuapp.com/adddealmodal/ttbroker",
      {
        method: "get",
        headers: { "Content-Type": "application/json" }
      }
  ...
  render() {
    ...
    const showHideClassName = this.props.show
      ? "deal-modal deal-display-block"
      : "deal-modal deal-display-none";
    return (
