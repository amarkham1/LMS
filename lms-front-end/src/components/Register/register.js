...
function validatePassword(password) {
	return (
		...
		passwordCaseError(password) ||
		passwordNumberError(password) ||
		passwordSymbolError(password)
	);
}
						...
						<div className="cont_text_inputs">
							...
							{this.state.passwordFocus ? (
								<div>
									...
									>
										Use upper and lower case letters (e.g.
										Aa) 2
									</p>
									<p
										className={
							...
							{shouldMarkError("confirmPassword") ? (
								<p className="error_text">
									Confirm password field must match the
									password field.
								</p>
							) : null}
						</div>
